   ...
   private FusedLocationProviderClient fusedLocationProviderClient;
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        for (int i =0 ; i < showInformationArrayList.size(); i++){
            LatLng position = new LatLng(showInformationArrayList.get(i).getLatitude(), showInformationArrayList.get(i).getLongitude());
            ...
            tvInformation.setText(showInformationArrayList.get(i).getContent());
        }


//        //lăng bác
//        LatLng LangBac = new LatLng(21.036747, 105.8347);
//        MarkerOptions option = new MarkerOptions();
//        option.position(LangBac);
//        option.title("Lăng Bác");
//        option.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
//        Marker maker = googleMap.addMarker(option);
//        maker.showInfoWindow();
